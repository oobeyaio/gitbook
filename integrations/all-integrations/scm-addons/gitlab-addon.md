---
description: Learn about GitLab & Oobeya integration.
icon: gitlab
---
...
2. Select _**read**_ permissions for the connection and click the **"Create personal access token"** button.&#x20;
...
3\. Copy and save the _access token_ to use on the Oobeya data source connection.
...
![](<../../../.gitbook/assets/Screenshot 2024-12-17 at 11.26.05.png>)
...
2\. Click the **"New Data Source"** button and fill in the form by using the _Access Token_ which was created on GitLab settings in the first step.
